...
class CategoryEntertainScreen extends StatefulWidget {
                ...
                return Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/images/entertainment-white.png',
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            entertainmentItems[index].title,
                            style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                            ),
                    ...
                    SizedBox(
                      child: Text(
                        entertainmentItems[index].amount,
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: oceanBlue,
                        ),
