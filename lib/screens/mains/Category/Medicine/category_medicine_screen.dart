...
class CategoryMedicineScreen extends StatefulWidget {
  const CategoryMedicineScreen({super.key});

  @override
  State<CategoryMedicineScreen> createState() => _CategoryMedicineScreenState();
}
