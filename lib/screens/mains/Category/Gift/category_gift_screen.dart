...
class CategoryGiftScreen extends StatefulWidget {
  const CategoryGiftScreen({super.key});

  @override
  State<CategoryGiftScreen> createState() => _CategoryGiftScreenState();
}

class _CategoryGiftScreenState extends State<CategoryGiftScreen> {
  @override
